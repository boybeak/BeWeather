...
public enum Skycon {
    ...
    CLEAR_NIGHT(R.string.text_clear_night, R.drawable.ic_weather_night, R.drawable.bg_sunny),
    ...
    CLOUDY(R.string.text_cloudy, R.drawable.ic_weather_cloudy, R.drawable.bg_sunny),
    RAIN(R.string.text_rain, R.drawable.ic_weather_pouring, R.drawable.bg_sunny),
